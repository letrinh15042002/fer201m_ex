                    ...
                    <div className="container">
                        <div className="row row-header">
                            <div className="col-12 col-sm-6">
                                ...
                                <p>  <p>We take inspiration from the World's best cuisines, and create a unique fusion experience. Our lipsmacking creations will tickle your culinary senses!</p></p>
                            </div>
                        </div>
                    </div>
                </div>
